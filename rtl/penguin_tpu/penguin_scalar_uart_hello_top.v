...
(
    ...
    wire [7:0] uart_tx_data = scalar_dmem_wdata[7:0];
    wire       uart_tx_valid = scalar_dmem_valid && scalar_dmem_write && (scalar_dmem_addr == UART_TX_ADDR);
    wire       uart_tx_ready;
    wire       uart_tx_busy;
...
`include "scalar/penguin_scalar_uart_hello_program_init.vh"
    end
