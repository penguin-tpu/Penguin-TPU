"""Run the MXU matmul example and emit a Perfetto trace."""
...
from penguin_model import PenguinCoreConfig, run_matmul_example
...
def main() -> int:
    ...
    result = run_matmul_example(trace_path=args.trace, config=config)

    print("Matmul example completed.")
