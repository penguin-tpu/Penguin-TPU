"""Run the larger DMA-backed stripmined MXU linear example and emit a Perfetto trace."""
...
from penguin_model import PenguinCoreConfig, run_large_linear_example
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--trace",
        type=Path,
        default=Path("outputs/examples/linear_large_trace.json"),
...
def main() -> int:
    ...
    print("Large linear example completed.")
