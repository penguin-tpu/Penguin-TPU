"""Run the larger DMA-backed stripmined MXU matmul example and emit a Perfetto trace."""
...
from penguin_model import PenguinCoreConfig, run_large_matmul_example
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--trace",
        type=Path,
        default=Path("outputs/examples/matmul_large_trace.json"),
...
def main() -> int:
    ...
    result = run_large_matmul_example(trace_path=args.trace, config=config)

    print("Large matmul example completed.")
